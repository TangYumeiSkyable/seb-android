...
import com.zxing.decoding.CaptureActivityHandler.BindNewDeviceListener;
...
public final class CaptureActivity extends BaseActivity implements SurfaceHolder.Callback {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setTitle(getString(R.string.airpurifier_more_show_scanqrcode_text));
...
//                handler = new CaptureActivityHandler(this, decodeFormats, decodeHints, characterSet, cameraManager);
            ...
            handler.setBindNewDeviceListener(new BindNewDeviceListener()
            {
				@Override
				public void bindNewDevice() {
                    //TODO Need to modify
//					Intent intent = new Intent(CaptureActivity.this, GuideActivity.class);
//					ConstantCache.appManager.addActivity(CaptureActivity.this);
//					startActivity(intent);
    ...
    private void displayFrameworkBugMessageAndExit() {
        ...
        //TODO Need to modify
//        new AlertDialogUserDifine(CaptureActivity.this).builder().setTitle("Camera access has been closed")
//		.setMsg(getString(R.string.msg_camera_framework_bug))
