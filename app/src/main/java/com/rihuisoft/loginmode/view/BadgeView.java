...
public class BadgeView extends TextView {
	...
	private static final int DEFAULT_CORNER_RADIUS_DIP = 3;
	...
	private void init(Context context, View target, int tabIndex) {
		try {
			...
			badgeMarginH = DipToPixels(this.context,DEFAULT_MARGIN_DIP);
			badgeMarginV = badgeMarginH;
			badgeColor = DEFAULT_BADGE_COLOR;
			
			setTypeface(Typeface.DEFAULT_BOLD);
			int paddingPixels = DipToPixels(this.context,DEFAULT_LR_PADDING_DIP);
...
//		ShapeDrawable drawable = new ShapeDrawable(rr);
	...
	private void applyLayoutParams() {
		try {
			...
			FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(dipToPixels(8), dipToPixels(8));
