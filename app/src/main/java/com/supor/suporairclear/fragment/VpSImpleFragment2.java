...
public class VpSImpleFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tv_airqualitytitle.setText(getString(R.string.airpurifier_more_airquality_moderate));
        ...
        tv_airqualitycontent.setText(getString(R.string.airpurifier_more_air_moderate_headline));
        ...
        tv_airqualitycontent2.setText(getString(R.string.airpurifier_more_air_moderate_description));
