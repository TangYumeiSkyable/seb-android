...
public class VpSImpleFragment6 extends Fragment {
    private int mTitle;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tv_airqualitytitle.setText(getString(R.string.airpurifier_more_airquality_extreme));
        ...
        tv_airqualitycontent.setText(getString(R.string.airpurifier_more_air_extreme_headline));
        ...
        tv_airqualitycontent2.setText(getString(R.string.airpurifier_more_air_extreme_description));
