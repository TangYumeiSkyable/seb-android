...
public class CountryAdapter extends BaseAdapter {
    ...
    public CountryAdapter(List<String> itemContent, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View inflate = LayoutInflater.from(mContext).inflate(R.layout.list_item_country, parent, false);
